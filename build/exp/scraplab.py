...
def writefile(fname,s,s1,heading):
	...
	content = f.read()
	content=content.replace('<h2 class="text-h2-lightblue" style=" margin-bottom: 20px; margin-top: 30px; ">Disciplines and Domains',breadcrumb)
	f.seek(0)
	f.write(content)
	print content
...
print heading
breadcrumb='<h2 class="text-h2-lightblue-small" style="font-weight: bold;margin-top: 0px;"><a href=".../../../computer-science-and-engineering-labs.html" class="sidebar-a" >Computer Science & Engineering</a><br/><a href="../Introduction.html" class="sidebar-a" >'+heading1+'</a><br/>'
while sectionNumber<=len(sectionno):
	...
	if tag1=='Prerequisite S/W':
		tag1='Prerequisites'
	st+='<a href="'+tag1+'.html?domain=Computer Science&lab='+heading1+'" class="sidebar-a" > <h3 class="text-h3-darkblue" style="margin-top: 2px; color: #ff6600;">'+tag1+'</h3></a>'	
	sectionNumber=sectionNumber+1
sectionNumber=1
while sectionNumber<=len(sectionno):
	tag=""
